...
namespace Ky\Core\Repositories;

use Closure;
use Illuminate\Contracts\Foundation\Application;
use Illuminate\Database\Eloquent\Model;
use Ky\Core\Contracts\RepositoryInterface;
use Ky\Core\Exceptions\RepositoryException;
use Ky\Core\Traits\HasCriteria;
use Ky\Core\Traits\HasOrder;
use Ky\Core\Traits\HasScope;
